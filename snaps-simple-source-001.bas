rem snaps-simple-source-001.bas -- https://github.com/CharlesNepote/snaps
rem .
rem **** Better use snaps-simple-001.bas****, a version of this script without comments
...
rem Main difference with snaps-001.bas:
rem   third parameter of md_detect_motion function is hardcoded to "1" in this script
